...
def mainpage():
    ...
    def information():
        ...
        def submit():
            ...
            c.execute(
                "INSERT INTO college VALUES(:name, :father_name, :mother_name, :address, :mobile_number, :dob, :gender )",
                {
                    'name': e1.get(),
                    'father_name': e2.get(),
                    'mother_name': e3.get(),
        ...
        select_name = Label(top, text="SELECT NO", font=('arial', 15, 'bold'), bg="gainsboro")
        ...
        e7 = ttk.Combobox(top, values=(' ', 'Male', 'Female', 'Others'), font=('arial', 17, 'bold'),
                          textvariable=gender, width=19)
        e7.place(x=200, y=360, width=250, height=30)

        # Creating a buttons
        savebutton = Button(top, text="SAVE", font=('arial', 15, 'bold'), command=submit, width=11, height=2,
                            bg="lightgrey")
        savebutton.place(x=80, y=625)

        displaybutton = Button(top, text="DISPLAY", font=('arial', 15, 'bold'), command=show, width=11, height=2,
                               bg="lightgrey")
        displaybutton.place(x=250, y=625)

        resetbutton = Button(top, text="RESET", font=('arial', 15, 'bold'), command=reset1, width=11, height=2,
                             bg="lightgrey")
        ...
        deletebutton = Button(top, text="DELETE", font=('arial', 15, 'bold'), command=delete, width=11, height=2,
                              bg="lightgrey")
        ...
        exitbutton = Button(top, text="EXT", font=('arial', 15, 'bold'), command=top.destroy, width=11, height=2,
                            bg="lightgrey")
    ...
    def marksheet():
        ...
        def create_new_win():
            new = Toplevel()
            new.title('Marksheet')
            new.geometry('1350x800')
            new.config(bg='gainsboro')
            ...
            f_Frame = LabelFrame(new,text="Student Details" ,font=('arial', 20, 'bold'), width=1200, height=220, bg='skyblue', bd=13)
            f_Frame.place(x=15, y=20)

            f_Frame = LabelFrame(new,text="Student Marks Obt" , font=('arial', 20, 'bold'), width=1300, height=500,
                                 bg='skyblue', bd=13)
            f_Frame.place(x=15, y=270)
            ...
            e7 = ttk.Combobox(new, values=(' ', 'Male', 'Female', 'Others'), font=('arial', 15, 'bold'),
                              textvariable=gender, width=19)
            ...
            savebutton = Button(new, text="SAVE", font=('arial', 15, 'bold'), command=save, width=11, height=0,
                                bg="lightgrey")
            ...
            exitbutton = Button(new, text="EXIT", font=('arial', 15, 'bold'), command=new.destroy, width=11, height=0,
                                bg="lightgrey")
        ...
        createbutton = Button(top, text="CREATE NEW ", font=('arial', 15, 'bold'), command=create_new_win, width=15,
                              height=1, bg="lightgrey")
    ...
    def feereport():
        ...
        label = Label(top, text="Informations", font=('arial', 17, "bold"), bg="gainsboro", padx=10, pady=10)
        ...
        e5 = ttk.Combobox(top, values=(' ', 'Bsc Hons Computing', 'Bsc Hons Ethical Hacking And Cyber Security',),
                          font=('arial', 15, 'bold'), textvariable=branch, width=19)
        ...
        e6 = ttk.Combobox(top,
                          ...
                          font=('arial', 15, 'bold'), textvariable=semester, width=19)
        ...
        # Creating a buttons
        savebutton = Button(top, text="SAVE", font=('arial', 14, 'bold'), command=submit1, width=11, height=1,
                            bg="lightgrey")
        savebutton.place(x=50, y=655)

        displaybutton = Button(top, text="DISPLAY", font=('arial', 15, 'bold'), command=show1, width=11, height=1,
                               bg="lightgrey")
        displaybutton.place(x=210, y=655)

        resetbutton = Button(top, text="RESET", font=('arial', 15, 'bold'), command=reseta, width=11, height=1,
                             bg="lightgrey")
        ...
        deletebutton = Button(top, text="DELETE", font=('arial', 15, 'bold'), command=delete1, width=11, height=1,
                              bg="lightgrey")
        ...
        receiptbutton = Button(top, text="RECEIPT NO", font=('arial', 15, 'bold'), command=receipt1, width=11, height=1,
                               bg="lightgrey")
        receiptbutton.place(x=1000, y=655)

        exitbutton = Button(top, text="EXT", font=('arial', 15, 'bold'), command=top.destroy, width=11, height=1,
                            bg="lightgrey")
    ...
    def menu():
        ...
        Frame_2 = LabelFrame(root, font=('arial', 17, 'bold'), width=1000, height=100, bg='skyblue')
        Frame_2.grid(row=2, column=0, padx=130, pady=40)

        Frame_3 = LabelFrame(root, font=('arial', 17, 'bold'), width=1000, height=100, bg='skyblue')
        Frame_3.grid(row=3, column=0, pady=7)

        # Defining the labels
        Label_1 = Label(Frame_1, text='STUDENT PROFILE', font=('arial', 25, 'bold'), bg='sky blue', bd=10)
        Label_1.grid(row=0, column=0, padx=50, pady=5)

        Label_2 = Label(Frame_2, text='FEE REPORT', font=('arial', 25, 'bold'), bg='skyblue', bd=10)
        Label_2.grid(row=0, column=0, padx=100, pady=5)

        Label_3 = Label(Frame_3, text='MARKSHEET', font=('arial', 25, 'bold'), bg='skyblue', bd=10)
        Label_3.grid(row=0, column=0, padx=101, pady=5)

        # Defining the buttons
        Button_1 = Button(Frame_1, text='VIEW', font=('arial', 16, 'bold'), bd=5, width=8, command=information)
        Button_1.grid(row=0, column=3, padx=50)

        Button_2 = Button(Frame_2, text='VIEW', font=('arial', 16, 'bold'), bd=5, width=8, command=feereport)
        Button_2.grid(row=0, column=3, padx=50)

        Button_3 = Button(Frame_3, text='VIEW', font=('arial', 16, 'bold'), bd=5, width=8, command=marksheet)
